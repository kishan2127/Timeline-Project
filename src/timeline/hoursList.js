  ...
  render() {
    ...
    return (
      <div className="hoursList">
        <div className="margin-bottom text-right hidden-in-print">
        ...
        <div className="inputFieldWrapper d-flex">
          <div className="unstyled-list hidden-in-print width-100 margin-0 padding-10">
            <div className="d-flex space-between font-weight align-center">
              <div className="text-field-input margin-0">
                Task Estimated Hours
              </div>
              <div className="date font-weight">Task End Date</div>
            </div>
          </div>
          <ul className="unstyled-list width-100 margin-0 hidden-in-print padding-10 margin-10 default-border ">
            {this.state.details.map(function (b, index) {
              return (
                <li
                  className="d-flex row-to-column align-top space-between list--item"
                  key={`${index}_${b}`}
                >
                  <SingleHourDetails
                    arry={b.hoursList}
        ...
        <div className="tableToPrint show-on-print">
          <ToPrint list={this.state.details} />
        </div>
        <div className="d-flex justify-center hidden-in-print">
          <Icon
            tabIndex="0"
